...
export default function Page() {
  ...
  return (
    <div className='w-full h-[955px] relative'>
      ...
      <section className='absolute rounded-2xl flex flex-col max-md:top-40 md:bottom-12 mx-auto right-2 left-2 pt-2 md:pt-6 px-6 md:w-[444px] h-[500px] md:h-[650px] bg-primary-50'>
        <CreateIcon />
      </section>
    </div>
  )
