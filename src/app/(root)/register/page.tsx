  ...
  return (
    <section className="h-full flex relative ">
      <div className="absolute">
        <div className="w-full h-28 bg-main"></div>
        <Image
      ...
      <main className="flex flex-col gap-2 pt-32 items-center mx-auto">
        ...
        <form action="" className="flex flex-col w-[250px] gap-2">
          <input
            ...
            className="bg-main placeholder:text-black p-2 text-xs rounded-md"
          />
          <input
            type="password"
          ...
          <button
            type="submit"
            className="bg-primary-100 text-white font-bold text-xl rounded-md"
          >
            CREATE
          </button>
        </form>
        ...
        <button className=" border-2 border-primary-100 w-full font-bold text-xl rounded-md mt-8">
          GOOGLE
        </button>
        ...
        <div className="text-[8px] flex gap-2 mt-2">
          ...
          <p className="font-thin">
            Do You Have Account?{" "}
            <Link rel="stylesheet" className="font-medium" href={"/login"}>
              Login !
            </Link>
          </p>
        </div>
      ...
      <div className="absolute bottom-0">
        ...
        <Image
          ...
          width={800}
          height={100}
          className="absolute rotate-180 -top-8 z-10"
        />
      </div>
    </section>
  );
