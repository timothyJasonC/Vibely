  ...
  return (
    <>
      <div className='flex flex-col gap-4'>
        ...
        <button
          className={`border-2 rounded-2xl py-6 px-32 ${postType === 'image' ? 'border-primary-200' : 'border-main bg-white'
            }`}
        ...
        <button
          className={`border-2 rounded-2xl py-6 px-32 ${postType === 'video' ? 'border-primary-200' : 'border-main bg-white'
            }`}
        ...
        <button
          className={`border-2 rounded-2xl py-6 px-32 ${postType === 'blog' ? 'border-primary-200' : 'border-main bg-white'
            }`}
